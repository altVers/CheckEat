    ...
    <>
      <section className="container px-6 flex gap-4 justify-center min-h-screen items-center relative z-10">
        <div className="flex flex-col gap-4 items-start  relative z-10">
          <h1
            className={classNames("font-black text-8xl", styles.content__title)}
          >
          ...
          <p
            className={classNames(
              "2xl:max-w-2xl xl:max-w-xl lg:max-w-lg md:max-w-md",
        ...
        <div className="relative w-[418px] h-[597px] z-5">
